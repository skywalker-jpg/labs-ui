...
## Ветки и запрос на слияние
- Все изменения были внесены в ветку `feature/frontend-prototype`.
- Создан запрос на слияние с основной веткой, который назначен на семинариста для ревью.
